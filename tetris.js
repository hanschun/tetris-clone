const canvasElement = document.getElementById('tetris-clone');
...
function drawSquare(x, y, color) {
    ...
    canvasContext.fillRect(x * SQUARE, y * SQUARE, SQUARE, SQUARE);
    canvasContext.strokeStyle = 'black';
    canvasContext.strokeRect(x * SQUARE, y * SQUARE, SQUARE, SQUARE);
}
